...
def s2orc_to_corwa_paragraph_index(paragraph_id, sentences, related_work_jsons,
    ...
    for citation in citations:
        ...
        if this_citation["ref_id"] is not None and "link" in bib_entries[this_citation["ref_id"]]:
            if bib_entries[this_citation["ref_id"]]["link"]:
                this_citation["link"] = bib_entries[this_citation["ref_id"]]["link"]
            else:
                this_citation["link"] = this_citation["ref_id"]
        elif this_citation["ref_id"] is not None and "links" in bib_entries[this_citation["ref_id"]]:
            if bib_entries[this_citation["ref_id"]]["links"]:
